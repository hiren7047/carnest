...
export class TemplateStaffMember extends Model<
  InferAttributes<TemplateStaffMember>,
  InferCreationAttributes<TemplateStaffMember>
> {
...
TemplateStaffMember.init(
  ...
  } as never,
  {
    ...
    tableName: "template_staff_members",
    modelName: "TemplateStaffMember",
  }
);
